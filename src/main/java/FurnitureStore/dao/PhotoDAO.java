...
import FurnitureStore.helper.IPhotoAccessor;
import FurnitureStore.helper.PhotoAccessor;
...
public class PhotoDAO extends AbstractDAO {
    ...
    public boolean setMainFalse(String id) throws Exception {
        try {
        	String query = "update Photo set IsMain=0 where Id = ?";
            // set main false in the database
        	try (PreparedStatement insert = PhotoDAO.super.connection.prepareStatement(query)) {
