...
import FurnitureStore.dto.ImportedProductDTO;
...
public class ImportDAO extends AbstractDAO {
    ...
    public void writeImportDTO(ImportDTO importDTO, ResultSet imports) throws Exception {
        ...
        importDTO.setPlacementDate(imports.getTimestamp("placementDate").toLocalDateTime());
    ...
    public boolean remove(Integer id) throws Exception {
        try {
            ...
            if(ImportDAO.super.ExecuteNonQuery(query, new Object[] { id })==0)
            {
            	return true;
            }
        } catch (Exception e) {
    ...
    public boolean removeImportedProduct(Integer id) throws Exception {
        try {
            ...
            if (ImportDAO.super.ExecuteNonQuery(query, new Object[] { id }) == 1)
                return true;
            return true;
        } catch (Exception e) {
            e.printStackTrace();
